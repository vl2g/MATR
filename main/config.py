...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        # * Running configs
        parser.add_argument("--dset_type", type=str, choices=["mr", "hl", "vs", "vlp"])    
        parser.add_argument("--dset_name", type=str, choices=["actnet", "sportsmr"])
        parser.add_argument("--domain_name", type=str, default=None)
        parser.add_argument("--model_id", type=str, default="MATR")
        ...
        parser.add_argument('--sub_enc_layers', default=4, type=int,
